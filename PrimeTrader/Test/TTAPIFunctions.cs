...
namespace ZeroSumAPI_Test
{
    ...
    class TTAPIFunctions : IDisposable
    {
        ...
        public void apiInstance_AuthenticationStatusUpdate(object sender, AuthenticationStatusUpdateEventArgs e)
        {
            ...
            {
                Console.WriteLine("TTAPIFunctions: TT Login successful!");
                ...
                lcd2.Add(new ContractDetails(MarketKey.Cbot, ProductType.Future, "ZB", "Dec17"));
                lcd2.Add(new ContractDetails(MarketKey.Cbot, ProductType.Future, "ZN", "Dec17"));
