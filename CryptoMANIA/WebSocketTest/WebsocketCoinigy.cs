...
{
    public class WebsocketCoinigy
    {
        private static readonly string WssUrl = "wss://sc-02.coinigy.com/socketcluster/";
        ...
        public bool Connect()
        {
            Console.WriteLine("WebsocketCoinigy::Connect()");
        ...
        {
            Console.WriteLine("WebsocketCoinigy::Socket_OnData()");
        ...
        {
            Console.WriteLine("WebsocketCoinigy::Socket_OnMessage()  {0}", message);
        ...
        {
            Console.WriteLine("WebsocketCoinigy::GetRequestType()  {0}", jObj);
        ...
        {
            Console.WriteLine("WebsocketCoinigy::InvokeMessageReceived()  {0} {1} {2}", channelName, requestType, message);
        ...
        {
            Console.WriteLine("WebsocketCoinigy::GetMessageType()  {0}", requestType);
    ...
    } // end of class WebsocketCoinigy




    public static class TestWebsocketCoinigy
    {
        ...
        {
            Console.WriteLine("TestWebsocketCoinigy::TryMe()");
        ...
        {
            Console.WriteLine("TestWebsocketCoinigy::Socket_OnClientReady()");
            // Subscribe to a new trade channel
            socket.SubscribeToTradeChannel("BMEX", "XBT", "USD");
        }
    } // end of class TestWebsocketCoinigy
