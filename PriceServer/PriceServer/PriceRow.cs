...
namespace IQFeed
{
    public class PriceRow : IDataRow
    {
        ...
        public List<IPriceRowListener> NotifyGrids { get { return m_notifyListenersOfUpdate; } }

        //int ix { get; set; }

        private List<IPriceRowListener> m_notifyListenersOfUpdate;
        ...
        public PriceRow(string symbol, string priceFormat = "0.0000")
        {
            ...
            m_notifyListenersOfUpdate = new List<IPriceRowListener>();
        }
        ...
        public void AddNotifyGrid(IPriceRowListener listener)
        {
            if (!m_notifyListenersOfUpdate.Contains(listener))
                m_notifyListenersOfUpdate.Add(listener);
        }
