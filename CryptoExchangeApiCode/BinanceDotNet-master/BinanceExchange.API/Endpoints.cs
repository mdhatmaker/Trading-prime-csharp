...
namespace BinanceExchange.API
{
    public static class Endpoints
    {
        ...
        /// </summary>
        internal static string APIBaseUrl = "https://api.binance.com/api"; // "https://www.binance.com/api";
        ...
        public static class Account
        {
            ...
            public static BinanceEndpointData NewOrder(CreateOrderRequest request)
            {
                ...
                //var timestamp = ((long)unixDateTime).ToString();
                //queryString = "symbol=TRXETH&side=BUY&type=LIMIT&timeInForce=GTC&quantity=200&price=0.00011470&recvWindow=5000&timestamp=1499827319559";
                //queryString = "symbol=TRXETH&side=BUY&type=LIMIT&timeInForce=GTC&quantity=200&price=0.00011470&recvWindow=5000&timestamp=" + timestamp;
            ...
            public static BinanceEndpointData NewOrderTest(CreateOrderRequest request)
            {
                ...
                var timestamp = ((long)unixDateTime).ToString();
                //queryString = "symbol=TRXETH&side=BUY&type=LIMIT&timeInForce=GTC&quantity=200&price=0.00011470&recvWindow=5000&timestamp=1499827319559";
                //queryString = "symbol=TRXETH&side=SELL&type=LIMIT&timeInForce=GTC&quantity=200&price=0.00011470&recvWindow=5000&timestamp=" + timestamp;
