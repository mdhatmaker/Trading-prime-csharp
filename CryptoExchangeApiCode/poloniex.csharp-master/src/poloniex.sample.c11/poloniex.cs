    ...
    public partial class Poloniex
    {
        ...
        public static async void XUserApi(int skip_step = 3)
        {
            ...
            if (skip_step == 3)
            {
                ...
                var _start_time = CUnixTime.DateTimeUnixEpochStart;
        ...
        public static async void XTradeApi(int skip_step = 1)
        {
            ...
            if (skip_step == 3)
            {
                var _post_order = await _trade_api.PlaceOrder(CurrencyPair.Parse("BTC_XRP"), OrderType.Sell, 0.00011000m, 1000.0m);
