...
namespace Aggregator
{
    ...
    public class TradeBinanceArbs
    {
        ...
        public static void BinanceStreams(string[] streamNames, string[] symbols)
        {
            ...
            var symbolList = new List<string>() { "ethusdt", "btcusdt", "neousdt", "neoeth", "neobtc", "bnbusdt", "bnbeth", "bnbbtc", "qtumusdt", "qtumeth", "qtumbtc", "ltcusdt", "ltceth", "ltcbtc", "bccusdt", "bcceth", "bccbtc", "adausdt", "adaeth", "adabtc" };
        ...
        static void Rebalance()
        {
            ...
            // NEO, QTUM, BNB, LTC, BCC, ADA => 0.004 BTC
            // ETH => 0.02 BTC
            // BTC => 0.02 BTC
            // USDT => 0.04 BTC
        ...
        public static void GetBalances(out decimal totalBtc, out decimal totalUsdt, bool display = false)
        {
            ...
            List<string> assets = new List<string>() { "ADA", "BCC", "BNB", "LTC", "NEO", "QTUM", "BTC", "ETH", "USDT" };
