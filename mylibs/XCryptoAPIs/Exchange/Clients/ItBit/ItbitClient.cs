...
{
    public class ItbitClient
    {
        private readonly string _clientKey;
        private readonly string _secretKey;
        private readonly HttpRequestBuilder _requestBuilder;

        public ItbitClient(string clientKey, string secretKey)
        {
        ...
        private HttpClient CreateMarketClient()
        {
            var client = new HttpClient
            {
        ...
        private async Task<HttpResponseMessage> MarketSendAsync(IMessageBuilder messageBuilder)
        {
            ...
            return await CreateMarketClient().SendAsync(request).ConfigureAwait(false);
        }
        ...
        public Task<Ticker> GetTickerAsync(TickerSymbol symbol)
        {
            ...
            return MarketSendAsync(request).ReadAsAsync<Ticker>();
        }
        ...
        public Task<OrderBook> GetOrderBookAsync(TickerSymbol symbol)
        {
            ...
            return MarketSendAsync(request).ReadAsAsync<OrderBook, OrderBookMediaTypeFormatter>();
        }
        ...
        public Task<RecentTrades> GetRecentTradesAsync(TickerSymbol symbol, int? since = null)
        {
            ...
            return MarketSendAsync(request).ReadAsAsync<RecentTrades>();
        }
    } // end of class TradeClient
