...
{
    // https://docs.tradeblock.com/
    // https://docs.tradeblock.com/#new-quote (for submitting quotes)

    public partial class TradeBlock : BaseApi, IExchangeWebSocket
    {
        public override string BaseUrl => "https://clientapi.tradeblock.com";
        public override string Name => "TRADEBLOCK";

        public static readonly string WebSocketUrl = "wss://clientapi.tradeblock.com/json/[ClientKey]";

        //TradeBlockClient m_api = TradeBlockClient.Instance;

        // SINGLETON
        public static TradeBlock Instance { get { return m_instance; } }
        private static readonly TradeBlock m_instance = new TradeBlock();
