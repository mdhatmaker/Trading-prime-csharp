...
namespace CryptoForms
{
    ...
    public partial class CryptoInfoForm : Form
    {
        ...
        public CryptoInfoForm()
        {
            ...
            gridPanel.Initialize();
            gridPanel.InitializeColumns(CryptoAPIs.BlockchainInfo.BlockchainInfoTicker.Columns, Color.White);
        ...
        {
            var dict = CryptoAPIs.BlockchainInfo.BlockchainInfoTicker.GetDictionary();
